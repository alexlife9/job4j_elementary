...
// значит метод должен вернуть строку "added".
// Для разности - "subtracted",
// умножения - "multiplied",
// деления - "divided".
//Если никакого арифметического действия над исходными значениями выполнить нельзя -
//метод должен вернуть строку "none".
